...
export function LegStatisticsTable({ legs, preferences }: LegStatisticsTableProps) {
  ...
  return (
    <section
      className={`leg-statistics${expanded ? ' expanded' : ''}`}
      aria-label="Leg statistics"
    >
      <button
        type="button"
        className="leg-statistics-toggle"
      ...
      >
        ...
        <span className="leg-statistics-toggle-icon" aria-hidden="true">
